...
import com.example.tourisum_app.adapter.likedAdapter;
...
public class Dashboard extends AppCompatActivity{
    ...
    ImageView acc, bookplan, explore,review;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //bookPlan activity
        bookplan = findViewById(R.id.book);
        bookplan.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Dashboard.this, BookPlan.class);
                startActivity(intent);
        ...
        seeAll_btn = findViewById(R.id.seeall);
        seeAll_btn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Dashboard.this, SeeAll_activity.class);
                startActivity(intent);
            }
        });
    ...
    private void filterList(String text) {
        ...
        List<likedData> likedDataList=new ArrayList<>();
        for(likedData likedData:likedDataList){
            if(likedData.getPlaceName().toLowerCase().contains(text.toLowerCase())){
                likedDataList.add(likedData);
            }
        }
        ...
        if(placeDetailsList.isEmpty()){
            ...
            likedAdapter.setFilteredList(likedDataList);
    ...
    private void setRecentRecycler(List<likedData> LikedDataList,List<placeDetails> placeDetailsList) {
        ...
        likedAdapter = new likedAdapter(this, LikedDataList,placeDetailsList);
